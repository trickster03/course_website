...
const Biomedical = () => {
  ...
  <Link to='/bio/video' className={biocss.link}><Card Heading="Vidoes" description="This course contains all the lecture videos, notes and assignments." Image={bio}/></Link>  
  <Link to='/bio/notes'  className={biocss.link}> <Card Heading="Notes" description="This course contains all the lecture videos, notes and assignments." Image={bio}/></Link> 
   <Link to='/physics/video'  className={biocss.link}><Card Heading="Assigment" description="This course contains all the lecture videos, notes and assignments." Image={bio}/></Link> 
   </div>
   </div>
  )
}
