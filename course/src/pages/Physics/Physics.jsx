...
const Physics = () => {
 ...
 <Link to='/physics/assignment' className={phycss.link}>  <Card Heading="Assigment" description="This course contains all the lecture videos, notes and assignments." Image={physics}/></Link> 
   </div>
   </div>
  )
}
